...
/* harmony import */ var _components_swiper_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/swiper.js */ "./src/js/components/swiper.js");
...
let yourFunc = () => {
  ...
  if ((0,_functions_check_viewport__WEBPACK_IMPORTED_MODULE_0__.isMobile)() && swiper !== undefined) {
    swiper.destroy(true, true);
    enableSwiper();
  } else if ((0,_functions_check_viewport__WEBPACK_IMPORTED_MODULE_0__.isMobile)()) {
    enableSwiper();
  } else if (!(0,_functions_check_viewport__WEBPACK_IMPORTED_MODULE_0__.isMobile)() && swiper !== undefined) {
    swiper.destroy(true, true);
  }
};

yourFunc();
let func = (0,_functions_throttle__WEBPACK_IMPORTED_MODULE_1__.throttle)(yourFunc);
window.addEventListener('resize', func);

function enableSwiper() {
  swiper = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"]('.testimonials__swiper', {
    slidesPerView: '1',
    spaceBetween: 20,
    autoHeight: true,
    pagination: {
...
/* harmony import */ var inputmask_lib_global_window__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! inputmask/lib/global/window */ "./node_modules/inputmask/lib/global/window.js");
...
(function () {
  ...
  inputmask_lib_global_window__WEBPACK_IMPORTED_MODULE_2__["default"].addEventListener('click', el => {
    const target = el.target;

    if (!target.closest('[data-menu]') && menu !== null && menu !== void 0 && menu.classList.contains('menu--active') && !target.closest('[data-burger]')) {
      menuActive();
    }
  });
